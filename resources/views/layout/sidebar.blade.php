        ...
        <nav class="space-y-4">
            @auth()
                ...
                @elseif( auth()->user()->role == 'dosen wali')
                    ...
                    <a href="{{ route('dosen.class.index') }}" class="block px-4 py-2 rounded hover:bg-indigo-600 hover:text-white">My Class</a>
                ...
                @elseif( auth()->user()->role == 'mahasiswa')
                    <a href="{{ route('mahasiswa.index') }}" class="block px-4 py-2 rounded hover:bg-indigo-600 hover:text-white">Dashboard</a>
